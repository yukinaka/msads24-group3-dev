        ...
        <form action="/jsys_group3/jsysFC" method="post">
            ...
            <div class="row row-cols-auto mb-3">
			    <div class="col-2">
	                ...
	                <div class="input-group mb-3">
	                	<input type="text" class="form-control" id="discountRate" name="discountRate" value="<c:out value="${ requestScope.customer.discountRate }" />" maxlength="2" pattern="^[1-9]?[0-9]$" title="割引率は0~99までの整数値で入力してください。" required>
	                	<span class="input-group-text">%</span>
					</div>
			    </div>
			 </div>
